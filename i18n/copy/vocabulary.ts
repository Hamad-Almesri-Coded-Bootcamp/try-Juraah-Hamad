...
export const vocabulary = {
  ...
  taken_on_time: { ar: 'أُخذت في وقتها', en: 'Taken on time', placeholder: true },
  ...
  severityWarning: { ar: 'راجع دكتورك', en: 'Check with your doctor', placeholder: true },
  severityInfo: { ar: 'للعلم', en: 'For your information', placeholder: true },
  pending_medical_review: {
    ar: 'لا يزال مراجع طبي يتحقق من هالتنبيه. هذي مو نتيجة نهائية.',
    en: 'A medical reviewer is still checking this. It is not a final answer yet.',
    placeholder: true,
  },
  reviewed: { ar: 'تحقق منه مراجع طبي.', en: 'Checked by a medical reviewer.', placeholder: true },
  auto_cleared: { ar: 'انفحص تلقائياً وما فيه تعارض.', en: 'Screened automatically. No interaction found.', placeholder: true },
  loading: { ar: 'يتم التحميل', en: 'Loading', placeholder: true },
  required: { ar: 'مطلوب', en: 'required', placeholder: true },
  empty: { ar: 'غير مسجل', en: 'Not recorded', placeholder: true },
  openDetail: { ar: 'افتح التفاصيل', en: 'Open details', placeholder: true },
  ...
  takePhoto: { ar: 'صوّر الوصفة', en: 'Take a photo', placeholder: true },
  choosePhoto: { ar: 'اختر صورة', en: 'Choose a photo', placeholder: true },
  analysing: { ar: 'جاري الفحص…', en: 'Analysing…', placeholder: true },
  secondsLeft: { ar: 'ثانية باقية', en: 'seconds left', placeholder: true },
  ...
  event_prescription_field_confirmed: { ar: 'تأكيد بيانات وصفة', en: 'Prescription fields confirmed', placeholder: true },
  ...
  event_schedule_recomputed: { ar: 'إعادة حساب الجدول', en: 'Schedule recomputed', placeholder: true },
  event_refill_requested: { ar: 'طلب تعبئة', en: 'Refill requested', placeholder: true },
  event_refill_status_changed: { ar: 'تغيّر حالة طلب التعبئة', en: 'Refill status changed', placeholder: true },
  ...
  event_caregiver_self_unlinked: { ar: 'إلغاء ربط مقدّم رعاية نفسه', en: 'Caregiver unlinked themselves', placeholder: true },
  event_messaging_connected: { ar: 'ربط تيليقرام', en: 'Telegram connected', placeholder: true },
  event_messaging_disconnected: { ar: 'فصل تيليقرام', en: 'Telegram disconnected', placeholder: true },
  event_push_enabled: { ar: 'تفعيل إشعارات المتصفح', en: 'Browser notifications enabled', placeholder: true },
  event_push_disabled: { ar: 'إيقاف إشعارات المتصفح', en: 'Browser notifications disabled', placeholder: true },
  event_tracking_enabled: { ar: 'تفعيل متابعة الجرعات', en: 'Adherence tracking enabled', placeholder: true },
  event_tracking_disabled: { ar: 'إيقاف متابعة الجرعات', en: 'Adherence tracking disabled', placeholder: true },
