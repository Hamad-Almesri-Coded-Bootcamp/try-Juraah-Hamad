...
| `routing` | none yet: no model chooses a route today (every patient photo goes to extraction). AP-11 builds `agents/lib/orchestrator.js` and wires this set | correct route | 95%, 15 inputs |
