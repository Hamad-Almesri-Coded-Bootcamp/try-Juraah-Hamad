...
- **The seed's brand names, checked against the SFDA register (AP-07).** BRUFEN and GLUCOPHAGE were verified from the SFDA register on 2026-09-24 (`verified: true` in `data/brand-map.json`), owner approval pending in the pull request. MAREVAN and LIPITOR were not in the SFDA list on 2026-09-24 (`pendingVerification`, `verified: false`), stay unverified, and Travel Check refuses them.
